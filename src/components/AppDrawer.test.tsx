...
describe('<AppDrawer>', () => {
  ...
  it('orders sections Home → Library → Theme → Feeds → App from top to bottom', () => {
    ...
    renderWithProviders(<AppDrawer open={true} onClose={() => {}} />);
    const sections = ['Home', 'Library', 'Theme', 'Text size', 'Feeds', 'App'];
  ...
  it('exposes the text-size stepper at the default size', () => {
    renderWithProviders(<AppDrawer open={true} onClose={() => {}} />);
    expect(
  ...
  it('steps the text size from the drawer', () => {
    renderWithProviders(<AppDrawer open={true} onClose={() => {}} />);
  ...
  it('links to the Settings page from the App section', () => {
    renderWithProviders(<AppDrawer open={true} onClose={() => {}} />);
  ...
  it('no longer hosts the Reading toggles (moved to the Settings page)', () => {
    renderWithProviders(<AppDrawer open={true} onClose={() => {}} />);
    expect(
    ...
    expect(
      screen.queryByRole('checkbox', { name: /sticky bottom toolbar/i }),
    ).toBeNull();
