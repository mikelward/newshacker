...
export function AboutPage() {
  return (
    <article className="about-page">
      <h1 className="about-page__title">About hnews.app</h1>
      <p>
        hnews.app is a mobile-friendly reader for{' '}
        <a
      ...
      <p>
        hnews.app is an independent project. It is{' '}
      ...
      <p>
        ...
        hnews.app does not host, moderate, or edit this content.
      </p>

      <h2 className="about-page__heading">What hnews.app stores</h2>
      <p>
        hnews.app keeps a small amount of data on your device (in
        ...
        server operated by hnews.app.
      </p>

      <h2 className="about-page__heading">Reporting content</h2>
      <p>
        hnews.app cannot remove or edit posts or comments. To flag
