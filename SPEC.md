...
The SW runtime cache is **additive** to the existing React Query persister (7-day retention for non-pinned stories, indefinite for pinned). RQ hydrates the UI on cold boot; the SW covers fetches RQ decides to make.
