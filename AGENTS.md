...
4. Keep the UI mobile-first. The palette is brand orange `#e65100` (Material Orange 900) on neutral greys — white in light mode, a neutral near-black (`#1b1b1b`) in dark mode. Darker hover shade `#bf360c` (Material Deep Orange 900) is exposed as `--nh-orange-dark`. Both themes share the same neutral-gray + orange logic — if you introduce a new surface hex, match the corresponding light/dark pair rather than reintroducing the old HN cream (`#f6f6ef`) or warm-tinted darks (`#1b1b17`, `#2f2f2a`, `#2a2a25`, etc.).
