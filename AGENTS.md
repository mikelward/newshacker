...
4. Keep the UI mobile-first and the palette deep orange (`#e65100` / `#f6f6ef`) — a darker, distinct shade from HN's own `#ff6600` so the brand mark reads as related-but-not-a-copy.
